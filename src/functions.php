...
function displaySpoonDetails(array $spoonRow): string {
    if(
        ...
        && array_key_exists('image', $spoonRow)) {
            return "<h2>" . $spoonRow['name'] . "</h2><p>Origin: " . $spoonRow['origin'] . "</p><p>Description: " . $spoonRow['description'] . "</p><p>Year: " . $spoonRow['year'] . "</p>" . "<img src='images/" . $spoonRow['image'] . "' alt='" . $spoonRow['name'] . "' width='200'>";
        }
